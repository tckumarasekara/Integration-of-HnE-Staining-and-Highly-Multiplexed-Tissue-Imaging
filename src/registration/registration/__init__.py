...
__all__ = ["colour_deconvolusion_preprocessing_HnE", "load_and_scale_images", "extract_channel", "register_DAPI_HnE", "register_feature_based", "features_with_SIFT", "compute_TRE", "compute_mutual_information",
